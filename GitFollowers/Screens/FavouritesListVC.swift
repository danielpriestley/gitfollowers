...
extension FavouritesListVC: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        // if we aren't doing a delete, don't do anything else
        ...
        PersistenceManager.updateWith(favorite: favorite, actionType: .remove) { [ weak self ] error in
            ...
            self.presentGFAlertOnMainThread(title: "Unable to delete", message: "Something went wrong when deleting.", buttonTitle: "Okay")
